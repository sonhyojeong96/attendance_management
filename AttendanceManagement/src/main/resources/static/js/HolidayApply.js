...
function categoryChange(type) {
	var grounds_6001 = ["旅行", "帰国"];
	var grounds_6002 = ["出産", "育児"];
	var grounds_6003 = ["本人結婚", "知人結婚", "知人死亡"];
	var grounds_6004 = ["健康診断", "手術"];
	var grounds_6005 = ["その他"];
	var target = document.getElementById("grounds");

	if(type.value == "6001") var d = grounds_6001;
	else if(type.value == "6002") var d = grounds_6002;
	else if(type.value == "6003") var d = grounds_6003;
	else if(type.value == "6004") var d = grounds_6004;
	else if(type.value == "6005") var d = grounds_6005;
