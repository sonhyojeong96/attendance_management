		...
		<div class="row">
			...
			<div class="col-md-7 col-sm-12">
				<div class="text-right mb-3">
					...
					<c:choose>
						<c:when test="${Date ne NowDate}"><!-- attSelect를 담은 list의 마지막 date1(Date)가 NowDate와 다를때 에러메세지를 출력하는 메소드 실행 -->
							<button type="button" class="btn btn-danger" onClick="errMag()">退勤</button>
						</c:when>
						<c:otherwise><!-- Date와 NowDate가 같을때 leaTime 메소드를 실행함-->
				...
				<table class="table table-striped table-hover mb-5"
					...
					<tbody class="table-striped2">
						<c:choose>
							<c:when test="${Bri eq true }"><!-- どういう意味? -->
								<tr>
									<th>出勤時間</th>
								...
								<tr>
									...
									<td><select name="content">
											...
											<option value="5001">社内勤務</option>
											<option value="5002">派遣勤務</option>
											<option value="5003">その他</option>
									</select>
